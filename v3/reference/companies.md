...
| --- | --- | --- | --- |
| `GET` | [`/companies/{company_id}/tracked_actions`](#list-tracked-actions) | TBD | List tracked actions |
| `GET` | [`/companies/{company_id}/action_models`](#list-action-models) | TBD | List action models |
