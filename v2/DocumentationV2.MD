...
| height_marker_type (not yet implemented) | node/midspan/both Optional addition for include_proposed_existing_and_markers. Set which height photos should include the height data. |
