...
const URL_PATH = 'https://katapultpro.com/api/v2/updatedJobsList';
const FROM_DATE = 'fromDate=2023-11-28T18:09:07.282Z';
const TO_DATE = 'toDate=11/29/23';
const USE_TODAY = 'useToday=true';
...
function runGetUpdatedJobsListReq() {      
   // Send it
   axios({
      method: 'get',
      url: `${URL_PATH}?${FROM_DATE}&${TO_DATE}&${USE_TODAY}&${PAGE_NUM}&api_key=${API_KEY}`
